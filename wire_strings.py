def horiz_wire(i,j):
    ...
    if im1 == "cold":
        ...
        lines.append("                     .neighbor1(wire_" + str(im1) + str(j) + "_" + str(i) + str(j) + "),")
        lines.append("                     .neighbor2(wire_" + str(im1) + str(jp1) + "_" + str(i) + str(jp1) + "),")
    if jm1 == "cold":
        lines.append("                     .neighbor3(cold),") 
    else:
        lines.append("                     .neighbor3(wire_" + str(i) + str(jm1) + "_" + str(i) + str(j) + "),")
    if jp2 == "cold":
        lines.append("                     .neighbor4(cold),")
    else:
        lines.append("                     .neighbor4(wire_" + str(i) + str(jp1) + "_" + str(i) + str(j+2) + "),")
    if ip1 == "cold":
        lines.append("                     .neighbor5(cold),")
        lines.append("                     .neighbor6(cold),")
    else:
        lines.append("                     .neighbor5(wire_" + str(i) + str(j) + "_" + str(ip1) + str(j) + "),")
        lines.append("                     .neighbor6(wire_" + str(i) + str(jp1) + "_" + str(ip1) + str(jp1) + "),")
...
def vert_wire(i,j):
    ...
    if i == 0:
        ...
        n2 = "wire_" + str(i-1) + str(j) + "_" + str(i) + str(j)
    if j == 0:
        n1 = cold
        n4 = cold
    else:
        n1 = "wire_" + str(i) + str(j-1) + "_" + str(i) + str(j)
        n4 = "wire_" + str(i+1) + str(j-1) + "_" + str(i+1) + str(j)
    if j == 8:
        n3 = cold
        n6 = cold
    else:
        n3 = "wire_" + str(i) + str(j) + "_" + str(i) + str(j+1)
        n6 = "wire_" + str(i+1) + str(j) + "_" + str(i+1) + str(j+1)
    if i == 7:
        n5 = cold
    else:
